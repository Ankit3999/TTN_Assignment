...
public class UsersDao {
    ...
    UsersDao(){
        usersModelList.add(new UsersModel(001, "ankit", 23, "ttn"));
        usersModelList.add(new UsersModel(002, "neha", 22, "ttn"));
        usersModelList.add(new UsersModel(003, "amisha", 21,"ttn"));
        usersModelList.add(new UsersModel(004, "ishika", 20,"ttn"));
        usersModelList.add(new UsersModel(005, "himanshu", 25,"ttn"));
    }
